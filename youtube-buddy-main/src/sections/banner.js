...
import bannerImage from 'assets/banner-mockups.png';
  ...
  return (
    <Box as="section" id="banner" sx={styles.banner}>
      <Container sx={styles.container}>
        ...
        <Heading as="h2">Meet your New Youtube AI Buddy</Heading>
        <Heading as="h6">Engage in interactive video viewing: Ask questions and immediately receive relevant answers about the video!</Heading>
...
const styles = {
  banner: {
    ...
    h6: {
      ...
      fontWeight: 500,
      width: '100%',
      maxWidth: ['80%', null, null, '55%', '500px', '640px', '851px'],
      mx: 'auto',
      mt: '30px',
